...
export default function Project({
  ...
  return (
    ...
    >
      <article className="bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[22rem] sm:mb-8 last:mb-0 even:pl-8 hover:bg-gray-200 transition sm:group-even:pl-5 dark:text-white dark:bg-white/10 dark:hover:bg-white/20 backdrop-blur-[0.5rem]">
